...
# for qr image: python decrypt_from_qr_shared.py --qr encrypted_qr.png --private-key keys/system_private.pem --out-file recovered.json
# decrypting from a JSON envelope file : python decrypt_from_qr_shared.py --qr encrypted_data.json --private-key keys/system_private.pem --out-file recovered.json
